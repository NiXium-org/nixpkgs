...
- The [Xen Hypervisor](https://xenproject.org) is once again available as a virtualisation option under `virtualisation.xen`.
  - This release includes [Xen 4.18](https://wiki.xenproject.org/wiki/Xen_Project_4.18_Release_Notes) and support for booting the hypervisor on EFI systems.
